📌 Descripción General
API REST para gestión de empleados desarrollada con Spring Boot. Permite realizar operaciones CRUD (Crear, Leer, Actualizar, Eliminar) sobre una lista de empleados en memoria.
...
src/main/java/com/techlab/libros/
├── controller/
...
└── exception/
    ...
    ├── SectorInvalidoException.java
    └── AnioInvalidoException.java
